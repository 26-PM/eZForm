...
function TestimonialsCards() {
    return (
        <div className="h-[30rem] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative">
            <h2 className='text-3xl font-bold text-center mt-8 pt-10 mb-8 z-10'>Voices of Success</h2>
